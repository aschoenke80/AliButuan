                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 top-full mt-1 w-52 bg-white rounded-xl shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                                ...
                                @if(auth()->user()->isOrganizer())
                                    ...
                                    <a href="{{ route('organizer.bookings.index') }}" class="flex items-center justify-between gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                ...
                @auth
                    <div class="border-t border-gray-100 mt-2 pt-2">
                        ...
                        @if(auth()->user()->isOrganizer())
                            ...
                            <a href="{{ route('organizer.bookings.index') }}" class="flex items-center justify-between px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 rounded-lg">
                                <span>📣 Booking Requests</span>
                                @if($pendingBookingsCount > 0)
                                    <span class="bg-orange-500 text-white text-xs font-bold px-1.5 py-0.5 rounded-full">{{ $pendingBookingsCount }}</span>
                                @endif
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                       class="text-gray-400 hover:text-pink-500 transition-colors" aria-label="Instagram">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
