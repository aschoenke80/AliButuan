...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification whereMessage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification whereType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification whereIsRead($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification query()
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<AppNotification>|AppNotification timeout(int $seconds)
     ...
     * @property string $title
     * @property mixed $organizer_id
     * @property int $id
     * @property-read mixed $category_emoji
     * @property-read \App\Models\User $organizer
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\EventFavorite> $favorites
     * @property-read int|null $favorites_count
     * @method static \Illuminate\Database\Eloquent\Builder<Event>|Event whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Event>|Event whereOrganizerId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Event>|Event whereAudience($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Event>|Event whereLocationName($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Event>|Event whereStartDatetime($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Event>|Event whereEndDatetime($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Event>|Event whereIsArchived($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<EventFavorite>|EventFavorite whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EventFavorite>|EventFavorite whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EventFavorite>|EventFavorite whereEventId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EventFavorite>|EventFavorite whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EventFavorite>|EventFavorite newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<EventFavorite>|EventFavorite newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<EventFavorite>|EventFavorite query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<EventFavorite>|EventFavorite timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class EventFavorite extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\EventFavorite> $favorites
     * @property-read int|null $favorites_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\AppNotification> $notifications
